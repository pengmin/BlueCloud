...
FROM(
	...
	FROM(
		SELECT
			...
			(CASE WHEN freeItem1='34#' OR freeItem1='4XL' THEN quantity ELSE 0 END) AS [34],
			(CASE WHEN freeItem1='35#' OR freeItem1='5XL' THEN quantity ELSE 0 END) AS [35],
			(CASE WHEN freeItem1='36#' OR freeItem1='6XL' THEN quantity ELSE 0 END) AS [36],
...
FROM(
	...
	FROM(
		SELECT
			specification,freeItem0,name,
			(CASE WHEN freeItem1='25#' OR freeItem1='S' THEN quantity ELSE 0 END) AS [25],
			(CASE WHEN freeItem1='26#' OR freeItem1='M' THEN quantity ELSE 0 END) AS [26],
			(CASE WHEN freeItem1='27#' OR freeItem1='L' THEN quantity ELSE 0 END) AS [27],
			(CASE WHEN freeItem1='28#' OR freeItem1='XL' THEN quantity ELSE 0 END) AS [28],
			(CASE WHEN freeItem1='29#' OR freeItem1='XXL' THEN quantity ELSE 0 END) AS [29],
			(CASE WHEN freeItem1='30#' OR freeItem1='XXXL' THEN quantity ELSE 0 END) AS [30],
			(CASE WHEN freeItem1='31#' OR freeItem1='4XL' THEN quantity ELSE 0 END) AS [31],
			(CASE WHEN freeItem1='32#' OR freeItem1='5XL' THEN quantity ELSE 0 END) AS [32],
			(CASE WHEN freeItem1='33#' OR freeItem1='6XL' THEN quantity ELSE 0 END) AS [33],
			(CASE WHEN freeItem1='34#' THEN quantity ELSE 0 END) AS [34],
