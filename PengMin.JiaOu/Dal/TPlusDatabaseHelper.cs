...
namespace PengMin.JiaOu.Dal
{
	...
	public class TplusDatabaseHelper
	{
		...
		/// 获取单例对象
		/// </summary>
		public static TplusDatabaseHelper GetInstance(SqlHelper sqlHelper)
		{
			return _instance ?? (_instance = new TplusDatabaseHelper(sqlHelper));
		}
		...
		private TplusDatabaseHelper(SqlHelper sqlHelper)
		{
