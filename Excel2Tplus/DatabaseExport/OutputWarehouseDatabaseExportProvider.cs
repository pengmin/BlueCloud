	...
	class OutputWarehouseDatabaseExportProvider : BaseDatabaseExportProvider<OutputWarehouse>
	{
		...
		protected override Tuple<string, IEnumerable<DbParameter>> BuildDetailInsertSql(OutputWarehouse obj, Guid pid)
		{
			...
			var ps = new DbParameter[]
			{
				...
				new SqlParameter("@origSaleAmount",decimal.TryParse(obj.销售金额,out amount)?amount:0m),
				...
				new SqlParameter("@taxSaleAmount",decimal.TryParse(obj.含税销售金额,out amount)?amount:0m),
				...
				new SqlParameter("@origTaxSalePrice", decimal.TryParse(obj.含税售价,out amount)?amount:0m),
				...
				new SqlParameter("@origSalePrice",decimal.TryParse(obj.售价,out amount)?amount:0m),
